...
VALUES
('Alice Johnson', 'alice@example.com', '$2b$10$zIc1U/MsUpVELbezeaWAneAyBAJO92d9c9BvmhpTRpSDz8wHvXDc.', '+1-555-0101', '1990-05-15', 0, 'seller', 'alice_designs', 'https://randomuser.me/api/portraits/women/45.jpg', 'Graphic designer specializing in logos and brand identity. 5+ years experience working with startups and SMEs.', 'United States', TRUE, 147),
('Mark Evans', 'mark@example.com', '$2b$10$UxNcBBRALLX7Gz7q2zBwieatxwyKsuuLTRU3DXU8TdxB8kBPGK5BK', '+44-20-7946-0958', '1985-03-22', 1, 'buyer', 'mark_evans', 'https://randomuser.me/api/portraits/men/32.jpg', 'Entrepreneur and startup founder looking for creative solutions to grow my business.', 'United Kingdom', FALSE, 23),
('Sophia Lee', 'sophia@example.com', '$2b$10$vkAUzd/GocsToikB1GAkwe/.Vi7dxUK.eNHcQNUhweoL1xRpi0B2.', '+1-416-555-0199', '1992-11-08', 0, 'seller', 'sophia_webdev', 'https://randomuser.me/api/portraits/women/55.jpg', 'Full-stack web developer with 6 years of experience. Expert in React, Node.js, and cloud deployment.', 'Canada', TRUE, 89),
('Carlos García', 'carlos@example.com', '$2b$10$mm.jCTT8LqToLRZD55ac8.hiVla0nFsrfQijeE7n6hcgHSzWF2EJe', '+34-91-123-4567', '1988-07-30', 1, 'buyer', 'carlos_g', 'https://randomuser.me/api/portraits/men/75.jpg', 'Digital marketing manager for a tech startup based in Madrid. Always looking for creative content.', 'Spain', TRUE, 31),
('Emma Tanaka', 'emma@example.com', '$2b$10$U.SgWzF35ltXURoTcRK/I.2aMF/hyzhRhCRt.7x/aaVA0NoWwOGV6', '+81-3-1234-5678', '1995-12-10', 0, 'seller', 'emma_translations', 'https://randomuser.me/api/portraits/women/28.jpg', 'Professional translator (EN/JP/ES) with JLPT N1 certification. Specialized in business and technical content.', 'Japan', FALSE, 76),
('David Miller', 'david@example.com', '$2b$10$m1YmUeGFLWDZeh.Ll.9dye6rcwBw9KoblK4gUsAovv4sazSipDvZi', '+1-555-0202', '1987-09-18', 1, 'seller', 'david_video', 'https://randomuser.me/api/portraits/men/67.jpg', 'Video editor and motion graphics designer. Worked on commercials and social media content for 200+ brands.', 'United States', TRUE, 134),
('Maria Silva', 'maria@example.com', '$2b$10$/pUA2IGOpi2rupbgUP2nK.x3fiTsqz8ZEzXtT2mLur.lkYppgbqRy', '+55-11-9876-5432', '1993-02-14', 0, 'seller', 'maria_seo', 'https://randomuser.me/api/portraits/women/82.jpg', 'SEO specialist and digital marketing consultant. Helped 50+ businesses improve their online visibility.', 'Brazil', TRUE, 67),
('Ahmed Hassan', 'ahmed@example.com', '$2b$10$rnUofSOSvsT7VsmOC7JnauJkUao0HbPbJQwKUBuUa1JI2E3JkywSS', '+20-10-1234-5678', '1989-12-03', 1, 'seller', 'ahmed_dev', 'https://randomuser.me/api/portraits/men/91.jpg', 'Mobile app developer specializing in Flutter and React Native. Built 30+ apps with 1M+ downloads.', 'Egypt', FALSE, 45),
('Lisa Chen', 'lisa@example.com', '$2b$10$wn1cROrYEmS9sYh4SMDSIuEkxJvloK2h3AtOKHtd951xbRVsHBpWu', '+86-138-0013-8000', '1991-06-25', 0, 'buyer', 'lisa_chen', 'https://randomuser.me/api/portraits/women/73.jpg', 'Product manager at a fintech company. Looking for design and development services for our platform.', 'China', TRUE, 18),
('Jean Dubois', 'jean@example.com', '$2b$10$W6T24tzJkfy3IvYa6.vUT.tVWtv7yF1i.m6HCLnWUGObrlvWZoVNu', '+33-1-42-86-83-00', '1986-04-12', 1, 'seller', 'jean_writer', 'https://randomuser.me/api/portraits/men/54.jpg', 'Content writer and copywriter fluent in French and English. 8 years of experience in B2B marketing content.', 'France', TRUE, 92),
('Nina Rodriguez', 'nina@example.com', '$2b$10$72cJ4Bjw77LQF34tDSQAHObQEJBdcNjjMZs8XAoVFaxthhJdUkrCm', '+52-55-1234-5678', '1994-08-17', 0, 'seller', 'nina_voice', 'https://randomuser.me/api/portraits/women/21.jpg', 'Professional voice over artist and audio producer. Fluent in English and Spanish with a warm, engaging voice perfect for commercials and e-learning.', 'Mexico', TRUE, 38),
('Ryan Thompson', 'ryan@example.com', '$2b$10$kT5pHwWTS0B0T6vwkoPaXOw61KMKLQI.YEMVbPNyVL3vX.eJoqI8m', '+1-555-0303', '1991-01-29', 1, 'buyer', 'ryan_startup', 'https://randomuser.me/api/portraits/men/25.jpg', 'Tech entrepreneur and app developer. Currently building a SaaS platform and looking for design and marketing services.', 'United States', FALSE, 15),
('Priya Patel', 'priya@example.com', '$2b$10$Girg8hADCw8/3B/q0At41u9ntR0.CdTRnZ5J20bw3z8emjmYVN0v2', '+91-98765-43210', '1989-11-05', 0, 'seller', 'priya_mobile', 'https://randomuser.me/api/portraits/women/67.jpg', 'Mobile UI/UX designer specializing in iOS and Android apps. Created award-winning designs for fintech and e-commerce applications.', 'India', TRUE, 56),
('Klaus Mueller', 'klaus@example.com', '$2b$10$TiRHVOOU0hI.eEohG3ZsuehLL8PnYqy7DI5C.cgmXO.gtWqPJzZUW', '+49-30-12345678', '1983-06-18', 1, 'seller', 'klaus_data', 'https://randomuser.me/api/portraits/men/43.jpg', 'Data scientist and business intelligence consultant. Expert in Python, SQL, and machine learning with 10+ years in analytics.', 'Germany', FALSE, 41),
('Isabella Costa', 'isabella@example.com', '$2b$10$kG9GIff61nUZq2Dx1BJPougu.Fz5WMjJjAQ/lock2FUVUA3uKfsUG', '+39-06-1234-5678', '1992-03-14', 0, 'buyer', 'isabella_fashion', 'https://randomuser.me/api/portraits/women/39.jpg', 'Fashion brand manager for luxury accessories. Seeking creative designers and social media experts for our upcoming campaigns.', 'Italy', TRUE, 27),
('Hiroshi Yamamoto', 'hiroshi@example.com', '$2b$10$/uQfq.0yLvqfLugAlST6ZuyJgWilBIaQWLams3XLnncMHUcuS6c36', '+81-90-1234-5678', '1987-09-22', 1, 'seller', 'hiroshi_3d', 'https://randomuser.me/api/portraits/men/78.jpg', '3D artist and game designer with expertise in Blender and Unity. Created assets for indie games and architectural visualizations.', 'Japan', TRUE, 29),
('Sarah Williams', 'sarah@example.com', '$2b$10$6fIBI4hyKUwDboKlNjStW.Acc5esBv4PRZ2q.cen7KcIR1JNyFmV.', '+1-416-555-0404', '1990-12-08', 0, 'seller', 'sarah_social', 'https://randomuser.me/api/portraits/women/51.jpg', 'Social media strategist and influencer marketing expert. Helped 100+ brands grow their online presence and engagement rates.', 'Canada', TRUE, 73),
('Mohammed Al-Rashid', 'mohammed@example.com', '$2b$10$SPtRofI.1NA3xnTiX.TK2O/Yv6Lr6uP9HhM/ktzJd7PfGSEl9t1Ym', '+971-4-123-4567', '1985-04-25', 1, 'buyer', 'mohammed_real_estate', 'https://randomuser.me/api/portraits/men/62.jpg', 'Real estate developer in Dubai. Looking for architectural visualization, marketing materials, and website development services.', 'UAE', FALSE, 12),
('Elena Petrov', 'elena@example.com', '$2b$10$tcr7IDkqXvCOTs0mochN.O0R1eqSjhNdwJg75.Udw7P.skZJOQ3Du', '+7-495-123-4567', '1993-07-11', 0, 'seller', 'elena_photo', 'https://randomuser.me/api/portraits/women/44.jpg', 'Professional photographer and photo editor. Specialized in product photography, portraits, and event coverage with advanced Photoshop skills.', 'Russia', TRUE, 64),
('Lucas Santos', 'lucas@example.com', '$2b$10$7tixmtXt6.BhxEmcukXFhO7OJps5yq1zZA1NNnkBk4wa4O8BLMWD6', '+55-21-9876-5432', '1988-10-03', 1, 'seller', 'lucas_backend', 'https://randomuser.me/api/portraits/men/35.jpg', 'Backend developer specializing in microservices and cloud architecture. Expert in Java, Spring Boot, and AWS with enterprise experience.', 'Brazil', TRUE, 47);
